...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.workspace.sareminderbackend.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://gitee.com/Elysia315k423/schedule-attendance-reminder\">Elysia315K-企业日程与智能考勤提醒平台</a>")
                .setSince("");
        return globalConfig;
    }
}
